...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('detalle_sdd', function (Blueprint $table) {
            $table->foreignId('n_documento')->references('n_documento')->on('suspencion_despacho');
    ...
    {
        Schema::dropIfExists('detalle_sdd');
    }
};
