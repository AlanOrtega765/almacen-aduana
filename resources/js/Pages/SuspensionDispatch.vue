...
import SuspensionDispatchForm from "@/Components/Forms/SuspensionDispatchForm.vue";
...
const props = defineProps(["suspensions"]);
    ...
    <AuthenticatedLayout>
        ...
        <section class="mt-10">
            ...
            <div class="w-full overflow-auto pb-4 my-10">
                <Table :columns="tableColumns" :items="suspensions.data" />
            </div>
        ...
        <Modal :show="show" :closeable="false">
            ...
            <SuspensionDispatchForm @close-modal="show = false"/>
        </Modal>
    </AuthenticatedLayout>
</template>
