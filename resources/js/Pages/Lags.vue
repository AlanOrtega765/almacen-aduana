...
import LagsForm from "@/Components/Forms/LagsForm.vue";
    ...
    <AuthenticatedLayout>
        ...
        <section class="mt-10">
            ...
            <div class="w-full overflow-auto pb-4 my-10">
                <Table :columns="tableColumns" :items="lags.data" />
            </div>
            <Pagination :links="lags.links" />
        </section>
        <Modal :show="show" :closeable="false">
            ...
            <LagsForm @close-modal="show = false"/>
        </Modal>
    </AuthenticatedLayout>
</template>
