...
class LagsController extends Controller
{
    /**
    ...
    {
        $rezagos = Retenciones::select('retenciones.n_boleta', 'retenciones.fecha_reten', 'retenciones.fecha_venc',
        ...
        return Inertia::render('Lags', ['lags' => $rezagos]);
    }
    ...
    {
        $rezago = Retenciones::select('retenciones.n_boleta', 'retenciones.fecha_reten', 'retenciones.fecha_venc',
                                        'personas.tipo_doc_p', 'personas.nro_id_person', 'personas.nombre_p', 'personas.apellido_p', 'personas.nacionalidad_p', 'personas.direccion_p', 'personas.ciudad_p',
        ...
        return Inertia::render('Documents/Lagspdf', ['lag' => $rezago]);
    }
